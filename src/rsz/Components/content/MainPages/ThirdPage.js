                ...
                <div className="container">
                    ...
                    <div className="info">
                        ...
                        <div className={styles.bottomWrapper}>
                            ...
                            <p className={styles.bottomDescription}>Хоча рідко, але можливі непередбачені обставини, які можуть вплинути на доставку. Навіть у випадку таких ситуацій, ми готові вирішити всі непорозуміння, навіть в умовах виникнення надзвичайних обставин.</p>
                        </div>
                    </div>
                </div>
            </main>
